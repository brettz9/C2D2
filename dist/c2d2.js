    ...
    */
    ...
    function buildGetterMethod(gm, methodFromProperty, WrapperClass) {
        return function (imageData) {
            ...
            if (gm === 'putImageData' && typeof imageData === 'object' && imageData.imageData) {
    ...
    function _C2D2ImageDataSetup() {
        const props = ['width', 'height', 'resolution' // Todo: The latter is read-only
        ],
              getterMethods = ['data'];
